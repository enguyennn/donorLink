...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 11.55C9.64 9.35 6.48 8 3 8v1.5c2.47 0 4.58.8 6.24 2.13C10.13 12.01 11 13.11 11 14.5c0 1.34.84 2.45 2 2.82V20c-3.52 0-6.64-1.35-9-3.55v1.5c2.36 2.2 5.48 3.55 9 3.55s6.64-1.35 9-3.55v-1.5C18.64 14.65 15.52 13.3 12 13.3c-1.38 0-2.65-.56-3.59-1.41C7.57 11.05 6.03 11 4.5 11H3c3.48 0 6.64 1.35 9 3.55V11.55z"/>
  </svg>
);

// New Apple Icon for Food
export const FoodIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.25 8.25 0 01-8.25-8.25c0-2.858 1.462-5.408 3.684-6.918 2.222-1.51 5.088-1.51 7.31 0 2.223 1.51 3.684 4.06 3.684 6.918A8.25 8.25 0 0112 21z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75c-1.25 0-2.25.75-2.25 1.5s1 1.5 2.25 1.5S14.25 6 14.25 5.25 13.25 3.75 12 3.75z" />
    </svg>
);


export const ClothingIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const BlanketIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const OtherIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-8.25 4.667-8.25-4.667m16.5 0l-8.25 4.667m8.25-4.667v10.5a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25V7.5m16.5 0l-8.25-4.667L3.75 7.5" />
    </svg>
);
...
export const FlameIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a3.75 3.75 0 00.495-7.467 5.99 5.99 0 00-1.925 3.546A3.75 3.75 0 0012 18z" />
  </svg>
);
...
export const ItemIcon: React.FC<{ itemType: ItemType, className?: string }> = ({ itemType, className }) => {
  switch (itemType) {
    case ItemType.Food:
      return <FoodIcon className={className} />;
    case ItemType.Clothing:
      return <ClothingIcon className={className} />;
    case ItemType.Hygiene:
      return <HygieneIcon className={className} />;
    case ItemType.Blankets:
      return <BlanketIcon className={className} />;
    default:
